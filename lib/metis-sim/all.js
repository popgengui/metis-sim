...
class gn_ChromosomePair {
    ...
    recombine_parent(ofs, parent, ofs_position, position) {
        for (let i=0; i<this.chromosome.size; i++) {
            ...
            const parent_position = this.chromosome.size -
                  (swap?
...
class ops_stats_FreqAl extends ops_GenomeCountStatistics {
    constructor(name='FreqAl', allele=1) {
    ...
    compute_counts(counts) {
        ...
        for (let marker in counts) {
            ...
            for (let ft_counts of counts[marker]) {
                ...
                freq_allele_marker.push((ft_counts[this.allele] || 0) / all_counts)
            }
...
class ops_stats_hz_ExpHeDeme extends ops_DemeStatistics {
    constructor() {
        super('ExpHe', () => new ops_stats_hz_ExpHe())
    }
}
    ...
    _generate_header() {
        ...
        for (let marker_name of genome.marker_order) {
            ...
            for (let feature=0; feature<marker.size/2; feature++) {
                this._text += marker_name + '_' + feature + '\n'
            }
        }
    }
        ...
        for (let pop in pop_inds) {
            ...
            for (let individual of pop_inds[pop]) {
                ...
                for (let pos=0; pos<size/2; pos++) {
                    ...
                    this._text += ('' + individual.genome[pos]).padStart(3, 0)
                    this._text += ('' + individual.genome[pos + size/2]).padStart(3, 0)
                }
                this._text += '\n'
            }
        }
...
module.exports.gn_AutosomeSNP = gn_AutosomeSNP
...
module.exports.i_assign_perc_male = i_assign_perc_male
...
module.exports.ops_wrap = ops_wrap
module.exports.ops_wrap_list = ops_wrap_list
module.exports.ops_BaseOperator = ops_BaseOperator
module.exports.ops_CycleStopOperator = ops_CycleStopOperator
module.exports.ops_DemeStatistics = ops_DemeStatistics
...
module.exports.ops_p_MigrationIslandFixed = ops_p_MigrationIslandFixed
module.exports.ops_p_MigrationSteppingStoneFixed = ops_p_MigrationSteppingStoneFixed
module.exports.ops_rep_annotate_with_parents = ops_rep_annotate_with_parents
module.exports.ops_rep_alpha_sire_factory = ops_rep_alpha_sire_factory
...
module.exports.ops_rep_AsexualRandomMater = ops_rep_AsexualRandomMater
...
module.exports.ops_rep_StructuredSexualReproduction = ops_rep_StructuredSexualReproduction
...
module.exports.ops_rep_asexual_random_mater_factory = ops_rep_asexual_random_mater_factory
module.exports.ops_rep_sex_ratio_sexual_generator_factory = ops_rep_sex_ratio_sexual_generator_factory
module.exports.ops_rep_no_genome_sexual_generator_factory = ops_rep_no_genome_sexual_generator_factory
module.exports.ops_stats_demo_SexStatistics = ops_stats_demo_SexStatistics
module.exports.ops_stats_NumAl = ops_stats_NumAl
module.exports.ops_stats_FreqAl = ops_stats_FreqAl
module.exports.ops_stats_hz_ExpHe = ops_stats_hz_ExpHe
module.exports.ops_stats_hz_ExpHeDeme = ops_stats_hz_ExpHeDeme
module.exports.ops_stats_TimeFix = ops_stats_TimeFix
module.exports.ops_stats_utils_SaveGenepop = ops_stats_utils_SaveGenepop
