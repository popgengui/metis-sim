...
export class RandomMater {
    *mate() {
        ...
        let random_mother_choice = new RandomChooser(mother_chooser).choice()
        let random_father_choice = new RandomChooser(father_chooser).choice()
        while (true) {

        yield [random_mother_choice.next(), random_father_choice.next()]
        }
    }
}
...
export class SexChooser extends Chooser {
    ...
    *choose() {
        for (let individual of source.choose()) {
